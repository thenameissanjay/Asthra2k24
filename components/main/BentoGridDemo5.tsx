...
export function BentoGridDemo5() {
  return (
    <Vortex
          ...
          <div className="m-4">
            ...
            <ul>
              <li className="max-w-4xl mx-auto text-slate-800 text-center text-1xl font-bold">
                - Maximum 2 Participants per team are allowed.
              </li>
              <li className="max-w-4xl mx-auto text-slate-800 text-center text-1xl font-bold">
...
const Contacts = () => (
  ...
  <div className="text-center">
   ...
   <div>
   <p className="text-2xl font-semibold text-black">Barath</p>
     <p className="text-1xl font-medium text-black">8778359672</p>
   </div>
   <div style={{ marginLeft: "-5px" }}>
